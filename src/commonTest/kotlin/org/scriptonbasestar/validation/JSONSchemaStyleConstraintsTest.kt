...
class JSONSchemaStyleConstraintsTest {
    ...
    fun typeConstraint() {
        ...
        assertEquals("must be of the correct type", anyValidation(1).get()!![0].message)
        assertEquals("must be of the correct type", anyNumberValidation("String").get()!![0].message)
    }
    ...
    fun stringEnumConstraint() {
        ...
        assertEquals("must be one of: 'OK', 'CANCEL'", validation("").get()!![0].message)
    }
    ...
    fun kotlinEnumConstraint() {
        ...
        assertEquals("must be one of: 'SYN', 'ACK'", partialEnumValidation(TCPPacket.SYNACK).get()!![0].message)
    ...
    fun multipleOfConstraint() {
        ...
        assertEquals("must be a multiple of '2.5'", validation(1).get()!![0].message)
    }
    ...
    fun minPropertiesConstraint() {
        ...
        assertEquals("must have at least 1 properties", validation(emptyMap()).get()!![0].message)
    }
    ...
    fun maxPropertiesConstraint() {
        ...
        assertEquals("must have at most 1 properties", validation(mapOf("a" to 0, "b" to 1)).get()!![0].message)
    }
    ...
    fun uniqueItemsConstraint() {
        ...
        assertEquals("all items must be unique", validation(listOf("a", "a")).get()!![0].message)
    }
}
